...
class CatalogService:
    ...
    def _initialize_sample_products(self):
        sample_products = [
            ...
            ("Adidas Runfalcon", "Леки спортни обувки", "бели", [36, 37, 38, 39, 40], 95.00, 12, 'sports', 'women',
             "/static/images/products/adidas_runfalcon.jpg"),
            ("Puma RS-X", "Ретро спортни обувки", "черни", [39, 40, 41, 42, 43], 110.00, 8, 'sports', 'unisex',
            ...
            ("UGG Classic", "Топли зимни ботуши", "кафяви", [36, 37, 38, 39], 180.00, 8, 'boots', 'women',
             "/static/images/products/ugg_classic.jpg"),
            ("Grand attack", "Класически ботуши", "зелени", [39, 40, 41, 42, 43], 160.00, 6, 'boots', 'unisex',
             "/static/images/products/grand.jpg"),
            ("Lowa", "Планински ботуши", "черни", [41, 42, 43, 44], 145.00, 4, 'boots', 'men',
             "/static/images/products/lowa.jpg"),

            # ЛЕТНИ ОБУВКИ
            (
            "Crocs", "Класически сандали", "бели и черни", [39, 40, 41, 42, 43], 90.00, 12, 'sandals', 'unisex',
            ...
            ("Nike", "Чехли", "черни и бели", [40, 41, 42, 43, 44], 65.00, 10, 'sandals', 'men',
